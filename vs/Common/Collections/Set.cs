...
namespace Common.Collections
{
    ...
    /// <p><see cref="OrderedSet&lt;T&gt;"/> is similar, but uses comparison instead of hashing, and maintains
    ...
    public class Set<T> : BaseCollection<T>, ICollection<T>, ICloneable
    {
        ...
        public IEqualityComparer<T> Comparer { get { return equalityComparer; } }
        ...
        public override sealed int Count { get { return hash.ElementCount; } }
