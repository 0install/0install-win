...
namespace Common.Collections
{
    ...
    [Serializable]
    [SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix", Justification = "This type is specifically a List, not just a normal Collection")]
    public abstract class BaseReadOnlyList<T> : BaseReadOnlyCollection<T>, IList<T>, IList
    {
        /// <summary>
        ...
        public virtual T this[int index] { get { throw new NotImplementedException(Resources.MustOverrideIndexerGet); } set { throw new NotSupportedException(string.Format(CultureInfo.CurrentUICulture, Resources.CannotModifyCollection, GetType().Name)); } }
        ...
        /// <returns><see langword="true"/> if the list contains an item that compares equal to <paramref name="item"/>.</returns>
        ...
        /// <returns><see langword="true"/> if an item that  satisfies the condition <paramref name="predicate"/> was found. False 
        ...
        object IList.this[int index] { get { return this[index]; } set { throw new NotSupportedException(string.Format(CultureInfo.CurrentUICulture, Resources.CannotModifyCollection, GetType().Name)); } }
    }
}