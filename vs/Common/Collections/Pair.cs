...
namespace Common.Collections
{
    ...
    public struct Pair<TFirst, TSecond> : IComparable, IComparable<Pair<TFirst, TSecond>>
    {
        ...
        /// <returns><see langword="true"/> if the pairs are equal. <see langword="false"/> if the pairs are not equal.</returns>
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "First: {0}, Second: {1}",
        ...
        /// <param name="pair1">First pair to compare.</param>
        /// <param name="pair2">Second pair to compare.</param>
        /// <returns><see langword="true"/> if the pairs are not equal. <see langword="false"/> if the pairs are equal.</returns>
        public static bool operator !=(Pair<TFirst, TSecond> pair1, Pair<TFirst, TSecond> pair2)
        {
            return !(pair1 == pair2);
        }
