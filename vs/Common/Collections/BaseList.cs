...
namespace Common.Collections
{
    ...
    public abstract class BaseList<T> : BaseCollection<T>, IList<T>, IList
    {
        /// <summary>
        ...
        /// <returns><see langword="true"/> if an item was found and removed that compared equal to
        /// <paramref name="item"/>. <see langword="false"/> if no such item was in the list.</returns>
        ...
        /// less than zero or greater than or equal to Count.</exception>
        /// <exception cref="ArgumentException"><paramref name="value"/> cannot be converted to T.</exception>
        object IList.this[int index] { get { return this[index]; } set { this[index] = ConvertToItemType("value", value); } }
    }
}