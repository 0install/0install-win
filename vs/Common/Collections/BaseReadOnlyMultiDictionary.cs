...
namespace Common.Collections
{
    ...
    public abstract class BaseReadOnlyMultiDictionary<TKey, TValue> : BaseReadOnlyCollection<KeyValuePair<TKey, ICollection<TValue>>>,
                                                                      IDictionary<TKey, ICollection<TValue>>
    {
        ...
        public virtual ICollection<TValue> this[TKey key] { get { return new ValuesForKeyCollection(this, key); } }
        ...
        /// </summary>
        [Serializable]
        private sealed class ValuesForKeyCollection : BaseReadOnlyCollection<TValue>
        {
            private readonly BaseReadOnlyMultiDictionary<TKey, TValue> myDictionary;
            ...
            public ValuesForKeyCollection(BaseReadOnlyMultiDictionary<TKey, TValue> myDictionary, TKey key)
            {
        ...
        private sealed class KeysCollection : BaseReadOnlyCollection<TKey>
        {
            ...
            public KeysCollection(BaseReadOnlyMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
        ...
        private sealed class ValuesCollection : BaseReadOnlyCollection<TValue>
        {
            ...
            public ValuesCollection(BaseReadOnlyMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
        ...
        private sealed class EnumerableValuesCollection : BaseReadOnlyCollection<ICollection<TValue>>
        {
            ...
            public EnumerableValuesCollection(BaseReadOnlyMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
        ...
        private sealed class KeyValuePairsCollection : BaseReadOnlyCollection<KeyValuePair<TKey, TValue>>
        {
            ...
            public KeyValuePairsCollection(BaseReadOnlyMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
