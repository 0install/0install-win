...
namespace Common.Collections
{
    ...
    public abstract class BaseCollection<T> : ICollection<T>, ICollection
    {
        /// <summary>
        ...
        {
            throw new NotImplementedException(Resources.MustOverrideOrReimplement);
        }
        ...
        /// </summary>
        /// <returns><see langword="true"/> if <paramref name="item"/> existed in the collection and
        /// was removed. <see langword="false"/> if <paramref name="item"/> did not exist in the collection.</returns>
        ...
        /// <returns><see langword="true"/> if the collection contains <paramref name="item"/>, <see langword="false"/>.</returns>
        ...
        public virtual void CopyTo(T[] array, int arrayIndex)
        {
            ...
            if (count < 0)
                throw new InvalidOperationException(Resources.ArgMustNotBeNegative);
            if (arrayIndex < 0)
                throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, Resources.ArgMustNotBeNegative);
            if (arrayIndex >= array.Length || count > array.Length - arrayIndex)
                throw new ArgumentException(Resources.ArrayTooSmall, "arrayIndex");
