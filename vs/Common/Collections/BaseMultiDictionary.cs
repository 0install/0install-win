...
namespace Common.Collections
{
    ...
    public abstract class BaseMultiDictionary<TKey, TValue> : BaseCollection<KeyValuePair<TKey, ICollection<TValue>>>, IDictionary<TKey, ICollection<TValue>>
    {
        /// <summary>
        ...
        /// <returns><see langword="true"/> if the key-value pair was found, <see langword="false"/>.</returns>
        ...
        /// <returns><see langword="true"/> if at least one values was found and removed.</returns>
        [SuppressMessage("Microsoft.Naming", "CA1725:ParameterNamesShouldMatchBaseDeclaration", Justification = "This method specifically removes an item pair, not just an item")]
        ...
        /// <summary>
        /// Determines if this dictionary contains a key equal to <paramref name="key"/>. If so, the first values
        /// associated with that key is returned.
        /// </summary>
        /// <param name="key">The key to search for.</param>
        public TValue GetFirstValue(TKey key)
        {
            IEnumerator<TValue> enumerator = this[key].GetEnumerator();
            enumerator.MoveNext();
        ...
        /// <returns><see langword="true"/> if the dictionary has associated <paramref name="value"/> with <paramref name="key"/>.</returns>
        ...
        /// <returns><see langword="true"/> if the dictionary has associated all of the values in <paramref name="pair"/>.Value with <paramref name="pair"/>.Key.</returns>
        [SuppressMessage("Microsoft.Naming", "CA1725:ParameterNamesShouldMatchBaseDeclaration", Justification = "This method specifically checks for an item pair, not just an item")]
        ...
        ICollection<ICollection<TValue>> IDictionary<TKey, ICollection<TValue>>.Values { get { return new EnumerableValuesCollection(this); } }
        ...
        /// with the key.
        /// </summary>
        public virtual ICollection<KeyValuePair<TKey, TValue>> KeyValuePairs { get { return new KeyValuePairsCollection(this); } }
        ...
        public virtual ICollection<TValue> this[TKey key] { get { return new ValuesForKeyCollection(this, key); } set { ReplaceMany(key, value); } }
        ...
        [SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly", Justification = "Required for interface implementation and harmless because into only throws a NotSupportedException")]
        ...
        /// <returns>Returns true if some values were removed. Returns <see langword="false"/> if <paramref name="key"/> was not
        ...
        /// </summary>
        [Serializable]
        private sealed class ValuesForKeyCollection : BaseCollection<TValue>
        {
            private readonly BaseMultiDictionary<TKey, TValue> myDictionary;
            ...
            public ValuesForKeyCollection(BaseMultiDictionary<TKey, TValue> myDictionary, TKey key)
            {
            ...
            /// <returns><see langword="true"/> if item was assocaited with key, <see langword="false"/>.</returns>
            ...
            /// </summary>
            public override int Count { get { return myDictionary.CountValues(key); } }
            ...
            /// <returns><see langword="true"/> if value is associated with key, <see langword="false"/>.</returns>
        ...
        private sealed class KeysCollection : BaseReadOnlyCollection<TKey>
        {
            ...
            public KeysCollection(BaseMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
        ...
        private sealed class ValuesCollection : BaseReadOnlyCollection<TValue>
        {
            ...
            public ValuesCollection(BaseMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
            ...
            public override IEnumerator<TValue> GetEnumerator()
            {
                using (var enumKeys = myDictionary.EnumerateKeys())
                {
                    while (enumKeys.MoveNext())
                    {
                        TKey key = enumKeys.Current;
        ...
        /// </summary>
        [Serializable]
        private sealed class EnumerableValuesCollection : BaseReadOnlyCollection<ICollection<TValue>>
        {
            private readonly BaseMultiDictionary<TKey, TValue> myDictionary;

            public EnumerableValuesCollection(BaseMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
        ...
        private sealed class KeyValuePairsCollection : BaseReadOnlyCollection<KeyValuePair<TKey, TValue>>
        {
            ...
            public KeyValuePairsCollection(BaseMultiDictionary<TKey, TValue> myDictionary)
            {
                this.myDictionary = myDictionary;
            }
