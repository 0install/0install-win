...
namespace Common.Collections
{
    ...
    internal class Hash<T> : IEnumerable<T>, ISerializable, IDeserializationCallback
    {
        ...
        private struct Slot
        {
            ...
            /// Is this slot empty?
            /// </summary>
            public bool Empty { get { return HashValue == 0; } }
        ...
        {
            return Util.GetHashCode(item, equalityComparer);
        }
            ...
            if (usedSlots + additionalItems > thresholdGrow)
            {
                ...
                while ((int)(newSize * loadFactor) < usedSlots + additionalItems)
                {
                    ...
                    if (newSize <= 0)
                    {
                        ...
                        throw new InvalidOperationException(Resources.CollectionTooLarge);
                    }
                }
        ...
        internal int SlotCount { get { return totalSlots; } }
        ...
        public float LoadFactor
        {
            ...
            set
            {
                ...
                if (value < 0.25 || value > 0.95)
                    throw new ArgumentOutOfRangeException("value", value, Resources.InvalidLoadFactor);
        ...
        /// <returns><see langword="true"/> if no duplicate existed, <see langword="false"/> if a duplicate was found.</returns>
        ...
        /// <returns><see langword="true"/> if item was found and deleted, <see langword="false"/> if item wasn't found.</returns>
        ...
        /// <returns><see langword="true"/> if the item was found, <see langword="false"/>.</returns>
        ...
        public Hash<T> Clone(Converter<T, T> cloneItem)
        {
            ...
            clone.count = count;
            clone.usedSlots = usedSlots;
            clone.totalSlots = totalSlots;
            clone.loadFactor = loadFactor;
            clone.thresholdGrow = thresholdGrow;
            clone.thresholdShrink = thresholdShrink;
            clone.hashMask = hashMask;
            clone.secondaryShift = secondaryShift;
            if (table != null)
            {
