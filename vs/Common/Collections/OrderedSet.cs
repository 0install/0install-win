...
namespace Common.Collections
{
    ...
    ///<seealso cref="Set&lt;T&gt;"/>
    [Serializable]
    [SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix", Justification = "This type is a special type of collection")]
    public class OrderedSet<T> : BaseCollection<T>, ICollection<T>, ICloneable
    {
        ...
        public OrderedSet<T> CloneContents()
        {
            ...
            if (!Util.IsCloneableType(typeof(T), out itemIsValueType))
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentUICulture, Resources.TypeNotCloneable, typeof(T).FullName));
        ...
        public override sealed int Count { get { return tree.ElementCount; } }
        ...
        /// <returns><see langword="true"/> if the set contains <paramref name="item"/>. <see langword="false"/> if the set does not contain <paramref name="item"/>.</returns>
        ...
        /// <returns><see langword="true"/> if the set already contained an item equal to <paramref name="item"/> (which was replaced), false 
        /// otherwise.</returns>
        ...
        /// <returns><see langword="true"/> if <paramref name="item"/> was found and removed. <see langword="false"/> if <paramref name="item"/> was not in the set.</returns>
        ...
        private void CheckConsistentComparison(OrderedSet<T> otherSet)
        {
            ...
            if (!Equals(comparer, otherSet.comparer))
                throw new InvalidOperationException(Resources.InconsistentComparisons);
        }
        ...
        /// <returns><see langword="true"/> if this is a superset of <paramref name="otherSet"/>.</returns>
        ...
        /// <param name="otherSet">OrderedSet to compare to.</param>
        /// <returns><see langword="true"/> if this is a proper superset of <paramref name="otherSet"/>.</returns>
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        ...
        /// <returns><see langword="true"/> if this is a subset of <paramref name="otherSet"/>.</returns>
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        ...
        /// <paramref name="otherSet"/>, and N is the size of the this set.</remarks>
        /// <param name="otherSet">Set to compare to.</param>
        /// <returns><see langword="true"/> if this is a proper subset of <paramref name="otherSet"/>.</returns>
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        ...
        /// this set.</remarks>
        /// <param name="otherSet">Set to compare to</param>
        /// <returns><see langword="true"/> if this set is equal to <paramref name="otherSet"/>, <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        ...
        /// <returns><see langword="true"/> if the two sets are disjoint, <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        ...
        /// </summary>
        [Serializable]
        private class ListView : BaseReadOnlyList<T>
        {
        ...
        public ViewCollection Reversed() // A reversed view that can be enumerated
        {
            return new ViewCollection(this, tree.EntireRangeTester, true, true);
        }
        ...
        public ViewCollection Range(T from, bool fromInclusive, T to, bool toInclusive) // A partial view that can be enumerated
        {
            return new ViewCollection(this, tree.DoubleBoundedRangeTester(from, fromInclusive, to, toInclusive), false, false);
        }
        ...
        /// be included in the range.</param>
        /// <returns>An OrderedSet.View of items in the given range.</returns>
        public ViewCollection RangeFrom(T from, bool fromInclusive) // A partial view that can be enumerated
        {
            return new ViewCollection(this, tree.LowerBoundedRangeTester(from, fromInclusive), false, false);
        }
        ...
        /// be included in the range.</param>
        /// <returns>An OrderedSet.View of items in the given range.</returns>
        public ViewCollection RangeTo(T to, bool toInclusive) // A partial view that can be enumerated
        {
            return new ViewCollection(this, tree.UpperBoundedRangeTester(to, toInclusive), false, false);
        }
        #endregion
        ...
        public class ViewCollection : BaseCollection<T>, ICollection<T>
        {
            private readonly OrderedSet<T> mySet;
            private readonly RedBlackTree<T>.RangeTester rangeTester; // range tester for the range being used.
            private readonly bool entireTree; // is the view the whole tree?
            ...
            /// <param name="entireTree">If true, then rangeTester defines the entire tree. Used to optimize some operations.</param>
            /// <param name="reversed">Is the view enuemerated in reverse order?</param>
            internal ViewCollection(OrderedSet<T> mySet, RedBlackTree<T>.RangeTester rangeTester, bool entireTree, bool reversed)
            {
                this.mySet = mySet;
                this.rangeTester = rangeTester;
                this.entireTree = entireTree;
            ...
            /// <returns><see langword="true"/> if the item is within the bounds of this view.</returns>
            ...
            {
                if (!ItemInView(item))
                    throw new ArgumentException(Resources.OutOfViewRange, "item");
                else
            ...
            /// <para>Removing an item from the set takes time O(log N), where N is the number of items in the set.</para></remarks>
            /// <param name="item">The item to remove.</param>
            /// <returns><see langword="true"/> if <paramref name="item"/> was found and removed. <see langword="false"/> if <paramref name="item"/> was not in the set, or
            ...
            /// <remarks>Searching the set for an item takes time O(log N), where N is the number of items in the set.</remarks>
            /// <param name="item">The item to search for.</param>
            /// <returns><see langword="true"/> if the set contains <paramref name="item"/>, and <paramref name="item"/> is within
            ...
            public ViewCollection Reversed()
            {
                return new ViewCollection(mySet, rangeTester, entireTree, !reversed);
            }
            ...
            public T GetFirst()
            {
                ...
                found = reversed ? mySet.tree.LastItemInRange(rangeTester, out item) : mySet.tree.FirstItemInRange(rangeTester, out item);
            ...
            public T GetLast()
            {
                ...
                found = reversed ? mySet.tree.FirstItemInRange(rangeTester, out item) : mySet.tree.LastItemInRange(rangeTester, out item);
