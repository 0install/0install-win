...
namespace Common.Collections
{
    ...
    public class OrderedBag<T> : BaseCollection<T>, ICloneable
    {
        ...
        /// <returns><see langword="true"/> if the bag contains <paramref name="item"/>. <see langword="false"/> if the bag does not contain <paramref name="item"/>.</returns>
        ...
        /// <returns><see langword="true"/> if <paramref name="item"/> was found and removed. <see langword="false"/> if <paramref name="item"/> was not in the bag.</returns>
        ...
        /// <returns><see langword="true"/> if this is a superset of <paramref name="otherBag"/>.</returns>
        ...
        /// <param name="otherBag">OrderedBag to compare to.</param>
        /// <returns><see langword="true"/> if this is a proper superset of <paramref name="otherBag"/>.</returns>
        /// <exception cref="InvalidOperationException">This bag and <paramref name="otherBag"/> don't use the same method for comparing items.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="otherBag"/> is null.</exception>
        ...
        /// <param name="otherBag">OrderedBag to compare to.</param>
        /// <returns><see langword="true"/> if this is a subset of <paramref name="otherBag"/>.</returns>
        /// <exception cref="InvalidOperationException">This bag and <paramref name="otherBag"/> don't use the same method for comparing items.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="otherBag"/> is null.</exception>
        ...
        /// <param name="otherBag">OrderedBag to compare to.</param>
        /// <returns><see langword="true"/> if this is a proper subset of <paramref name="otherBag"/>.</returns>
        /// <exception cref="InvalidOperationException">This bag and <paramref name="otherBag"/> don't use the same method for comparing items.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="otherBag"/> is null.</exception>
        ...
        /// <returns><see langword="true"/> if the two bags are disjoint, <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">This bag and <paramref name="otherBag"/> don't use the same method for comparing items.</exception>
        ...
        /// this bag.</remarks>
        /// <param name="otherBag">OrderedBag to compare to</param>
        /// <returns><see langword="true"/> if this bag is equal to <paramref name="otherBag"/>, <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">This bag and <paramref name="otherBag"/> don't use the same method for comparing items.</exception>
        ...
        public class ViewCollection : BaseCollection<T>
        {
            private readonly OrderedBag<T> myBag;
            private readonly RedBlackTree<T>.RangeTester rangeTester; // range tester for the range being used.
            private readonly bool entireTree; // is the view the whole tree?
            ...
            /// <param name="reversed">Is the view enuemerated in reverse order?</param>
            internal ViewCollection(OrderedBag<T> myBag, RedBlackTree<T>.RangeTester rangeTester, bool entireTree, bool reversed)
            {
                this.myBag = myBag;
                this.rangeTester = rangeTester;
                this.entireTree = entireTree;
            ...
            /// <returns><see langword="true"/> if the bag already contained an item equal to <paramref name="item"/> (which was replaced), false 
            /// otherwise.</returns>
            public override sealed void Add(T item)
            {
                if (!ItemInView(item))
            ...
            /// <para>Removing an item from the bag takes time O(log N), where N is the number of items in the bag.</para></remarks>
            /// <param name="item">The item to remove.</param>
            /// <returns><see langword="true"/> if <paramref name="item"/> was found and removed. <see langword="false"/> if <paramref name="item"/> was not in the bag, or
            ...
            /// <remarks>Searching the bag for an item takes time O(log N), where N is the number of items in the bag.</remarks>
            /// <param name="item">The item to search for.</param>
            /// <returns><see langword="true"/> if the bag contains <paramref name="item"/>, and <paramref name="item"/> is within
            ...
            {
                return new ViewCollection(myBag, rangeTester, entireTree, !reversed);
            }
