...
{
    /// <summary>
    /// Contains test methods for <see cref="WorkingDirBinding"/>.
    /// </summary>
    [TestFixture]
    public class WorkingDirBindingTest
    {
        #region Helpers
        /// <summary>
        /// Creates a fictive test <see cref="WorkingDirBinding"/>.
        /// </summary>
        internal static WorkingDirBinding CreateTestBinding()
        {
            return new WorkingDirBinding { Source = @"somedir" };
        }
        #endregion
