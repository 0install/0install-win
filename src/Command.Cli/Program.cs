...
namespace ZeroInstall.Command.Cli
{
    #region Enumerations
    /// <summary>
    ...
    public static class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            if (arguments.Contains("run")) arguments.Remove("run"); else return (int)ErrorLevel.NotSupported;

            // Automatically show help for missing args
            if (arguments.Count == 0) arguments.AddFirst("--help");
