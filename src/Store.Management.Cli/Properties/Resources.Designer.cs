...
namespace ZeroInstall.Store.Management.Cli.Properties {
    ...
    internal class Resources {
        ...
        /// </summary>
        internal static string DetailsPurge {
            get {
                return ResourceManager.GetString("DetailsPurge", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to 0store purge [CACHE+].
        /// </summary>
        internal static string UsagePurge {
            get {
                return ResourceManager.GetString("UsagePurge", resourceCulture);
            }
        }
