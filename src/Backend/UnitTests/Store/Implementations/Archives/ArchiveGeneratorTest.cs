...
namespace ZeroInstall.Store.Implementations.Archives
{
        ...
        where T : ArchiveGenerator
    {
        ...
        protected Stream ArchiveReadStream;
        ...
        protected override void Execute()
        {
            ...
            // Must open new stream for reading because write stream gets closed
            ArchiveReadStream = new MemoryStream(_archiveWriteStream.GetBuffer());
        }
    }
}
