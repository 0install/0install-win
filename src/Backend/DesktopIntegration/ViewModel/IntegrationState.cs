...
namespace ZeroInstall.DesktopIntegration.ViewModel
{
    ...
    public partial class IntegrationState
    {
        ...
        /// <exception cref="ConflictException">Thrown if one or more of the new <see cref="AccessPoints.AccessPoint"/>s would cause a conflict with the existing <see cref="AccessPoints.AccessPoint"/>s in <see cref="IIntegrationManager.AppList"/>.</exception>
