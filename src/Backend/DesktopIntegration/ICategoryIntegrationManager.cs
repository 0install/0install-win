...
namespace ZeroInstall.DesktopIntegration
{
    ...
    public interface ICategoryIntegrationManager : IIntegrationManager
    {
        ...
        /// <exception cref="ConflictException">Thrown if one or more of the <paramref name="categories"/> would cause a conflict with the existing <see cref="AccessPoint"/>s in <see cref="AppList"/>.</exception>
