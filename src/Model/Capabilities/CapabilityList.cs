...
namespace ZeroInstall.Model.Capabilities
{
    ...
    public sealed class CapabilityList : XmlUnknown, ICloneable, IEquatable<CapabilityList>
    {
        ...
        [XmlElement(typeof(AppRegistration)), XmlElement(typeof(AutoPlay)), XmlElement(typeof(ComServer)), XmlElement(typeof(ContextMenu)), XmlElement(typeof(DefaultProgram)), XmlElement(typeof(FileType)), XmlElement(typeof(GamesExplorer))]
