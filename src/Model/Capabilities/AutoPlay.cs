...
namespace ZeroInstall.Model.Capabilities
{
    ...
    public sealed class AutoPlay : IconCapability, IEquatable<AutoPlay>
    {
        ...
        {
            var capability = new AutoPlay {UnknownElements = UnknownElements, UnknownAttributes = UnknownAttributes, ID = ID, ExplicitOnly = ExplicitOnly, Provider = Provider, ProgID = ProgID, Verb = Verb.Clone()};
