...
namespace ZeroInstall.DesktopIntegration.AccessPoints
{
    ...
    public abstract class AccessPoint : XmlUnknown, ICloneable
    {
        ...
        /// <exception cref="InvalidDataException">Thrown if the access point's data or a referenced <see cref="ZeroInstall.Model.Capabilities.Capability"/>'s data are invalid.</exception>
