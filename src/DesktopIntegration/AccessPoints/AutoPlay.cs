    ...
    public class AutoPlay : DefaultAccessPoint, IEquatable<AutoPlay>
    {
        ...
        public override void Apply(AppEntry appEntry, Feed feed, bool systemWide, ITaskHandler handler)
        {
            ...
            if (WindowsUtils.IsWindows)
                Windows.AutoPlay.Register(new InterfaceFeed(appEntry.InterfaceID, feed), capability, true, systemWide, handler);
        }
        ...
        public override void Unapply(AppEntry appEntry, bool systemWide)
        {
            ...
            if (WindowsUtils.IsWindows)
                Windows.AutoPlay.Unregister(capability, true, systemWide);
        }
        #endregion
        ...
        {
            return new AutoPlay {UnknownElements = UnknownElements, UnknownAttributes = UnknownAttributes, Capability = Capability};
        }
        #endregion
