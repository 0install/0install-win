    ...
    public class AutoPlay : DefaultAccessPoint, IEquatable<AutoPlay>
    {
        ...
        public override void Apply(AppEntry appEntry, Feed feed, bool machineWide, ITaskHandler handler)
        {
            ...
            if (WindowsUtils.IsWindows)
                Windows.AutoPlay.Register(new InterfaceFeed(appEntry.InterfaceID, feed), capability, true, machineWide, handler);
        }
        ...
        public override void Unapply(AppEntry appEntry, bool machineWide)
        {
            ...
            if (WindowsUtils.IsWindows)
                Windows.AutoPlay.Unregister(capability, true, machineWide);
        }
        #endregion
