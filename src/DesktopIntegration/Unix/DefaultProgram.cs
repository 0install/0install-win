...
{
    /// <summary>
    /// Contains control logic for applying <see cref="Capabilities.DefaultProgram"/> and <see cref="AccessPoints.DefaultProgram"/> on GNOME or KDE systems.
    /// </summary>
    public static class DefaultProgram
    {
        ...
        public static void Register(InterfaceFeed target, Capabilities.DefaultProgram defaultProgram, bool machineWide, ITaskHandler handler, bool accessPoint = false)
        {
        ...
        /// <exception cref="UnauthorizedAccessException">Thrown if write access to the filesystem is not permitted.</exception>
        /// <exception cref="InvalidDataException">Thrown if the data in <paramref name="defaultProgram"/> is invalid.</exception>
        public static void Unregister(Capabilities.DefaultProgram defaultProgram, bool machineWide, bool accessPoint = false)
        {
            #region Sanity checks
            if (defaultProgram == null) throw new ArgumentNullException("defaultProgram");
            #endregion
