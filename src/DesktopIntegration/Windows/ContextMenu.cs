...
{
    /// <summary>
    /// Contains control logic for applying <see cref="ZeroInstall.Model.Capabilities.ContextMenu"/> and <see cref="ZeroInstall.DesktopIntegration.Model.ContextMenu"/> on Windows systems.
    /// </summary>
