...
namespace ZeroInstall.Store.Feeds
{
    ...
    public struct OpenPgpSecretKey
    {
        ...
        public OpenPgpSecretKey(int bitLength, PgpAlgorithm keyType, string keyID, DateTime creationDate, string userID)
        {
            BitLength = bitLength;
            Algorithm = keyType;
            KeyID = keyID;
        ...
        /// <summary>
        /// Creates a new <see cref="IOpenPgp"/> secret key representation from a console line.
        /// </summary>
        /// <param name="line">A console line generated by "gpgp --list-secret-keys --with-colons".</param>
        /// <returns>The parsed see <see cref="IOpenPgp"/> secret key representation.</returns>
        /// <exception cref="FormatException">Thrown <paramref name="line"/> cannot be properly parsed.</exception>
        public static OpenPgpSecretKey Parse(string line)
        {
