...
{
    #region Enumerations
    /// <seealso cref="PgpSecretKey.Algorithm"/>
    ...
    /// <summary>
    /// Represents a secret key stored in a local <see cref="IPgp"/> profile.
    /// </summary>
    public struct PgpSecretKey
    {
        #region Variables
        /// <summary>
        ...
        /// </summary>
        public readonly PgpAlgorithm Algorithm;
        ...
        #region Constructor
        /// <summary>
        /// Creates a new <see cref="IPgp"/> secret key representation.
        /// </summary>
        ...
        public PgpSecretKey(int bitLength, PgpAlgorithm keyType, string keyID, DateTime creationDate, string userID)
        {
            BitLength = bitLength;
            Algorithm = keyType;
            KeyID = keyID;
        ...
        /// <summary>
        /// Creates a new <see cref="IPgp"/> secret key representation from a console line.
        /// </summary>
        /// <param name="line">A console line generated by "gpgp --list-secret-keys --with-colons".</param>
        /// <returns>The parsed see <see cref="IPgp"/> secret key representation.</returns>
        /// <exception cref="FormatException">Thrown <paramref name="line"/> cannot be properly parsed.</exception>
        public static PgpSecretKey Parse(string line)
        {
            ...
            return new PgpSecretKey(
                ...
                (PgpAlgorithm)int.Parse(componenets[3]),
                componenets[4],
