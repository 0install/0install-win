...
public static class ProgramUtils
{
    ...
    public static ExitCode Run(string[] args, IBootstrapHandler handler)
    {
        ...
        {
#if NETFRAMEWORK
            if (RegistryUtils.GetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\NET Framework Setup\NDP\v4\Full", "Release") < 528040)
                throw new IOException("Please download and install .NET Framework 4.8 or later: https://dotnet.microsoft.com/en-us/download/dotnet-framework");
#endif
