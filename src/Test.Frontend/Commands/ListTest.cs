...
namespace ZeroInstall.Commands
{
    ...
    public class ListTest : FrontendCommandTest
    {
        ...
        public void TestNoArgs()
        {
            ...
            AssertParseExecuteResult(null, "http://0install.de/feeds/test/test1.xml" + Environment.NewLine + "http://0install.de/feeds/test/test2.xml", 0);
        }
        ...
        {
            CacheMock.Setup(x => x.ListAll()).Returns(new[] {"http://0install.de/feeds/test/test1.xml", "http://0install.de/feeds/test/test2.xml"});
            AssertParseExecuteResult(null, "http://0install.de/feeds/test/test2.xml", 0,
                "test2");
        }
