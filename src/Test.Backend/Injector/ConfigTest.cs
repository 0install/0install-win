...
namespace ZeroInstall.Injector
{
    ...
    public class ConfigTest
    {
        ...
        {
            return new Config {HelpWithTesting = true, Freshness = new TimeSpan(12, 0, 0, 0), NetworkUse = NetworkLevel.Minimal, AutoApproveKeys = false, SelfUpdateEnabled = false, SelfUpdateID = "invalid"};
        }
        #endregion
