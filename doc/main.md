The Zero Install Frontend consists of the libraries `ZeroInstall.Commands` and `ZeroInstall.Central` as well a set of executables. This is the main UI and command-line interface of Zero Install.
