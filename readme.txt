...
- Portable: Contains a portable Python distribution (Windows only), a portable GnuPG distribution (Windows only) and the Python solver script (all platforms). See below how to get these files.
...
- On Windows call "install_full.cmd [SVN_CHECKOUT_DIR]\build\Portable\Python".
- On Linux call "install_copy.sh [SVN_CHECKOUT_DIR]/build/Portable/Python".
