...
Keep in sync with the version numbers in `ZeroInstall.xml`, `ZeroInstall_Tools.xml`, `ZeroInstall_Updater.xml`, `src/AssemblyInfo.Global.cs`, and `src/Updater/AssemblyInfo.Updater.cs`!
