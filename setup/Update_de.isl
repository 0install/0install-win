...
; *** SetupLdr messages
SetupLdrStartupMessage=%1 wird jetzt aktualisiert. Möchten Sie fortfahren?
...
ExitSetupMessage=Das Setup ist noch nicht abgeschlossen. Wenn Sie jetzt beenden, wird das Programm nicht erneuert.%n%nSie können das Setup-Programm zu einem späteren Zeitpunkt nochmals ausführen, um das Update zu vervollständigen.%n%nSetup verlassen?
...
WelcomeLabel2=Dieser Assistent wird jetzt [name/ver] auf Ihren Computer aktualisieren.%n%nSie sollten alle anderen Anwendungen beenden, bevor Sie mit dem Setup fortfahren.
...
WizardReady=Update durchführen
ReadyLabel1=Das Setup ist jetzt bereit, [name] auf Ihren Computer zu aktualisieren.
ReadyLabel2a=Klicken Sie auf "Aktualisieren", um mit dem Update zu beginnen, oder auf "Zurück", um Ihre Einstellungen zu überprüfen oder zu ändern.
ReadyLabel2b=Klicken Sie auf "Aktualisieren", um mit dem Update zu beginnen.
...
WizardPreparing=Vorbereitung des Updates
PreparingDesc=Das Setup bereitet das Update von [name] auf diesen Computer vor.
PreviousInstallNotCompleted=Eine vorherige Installation/Deinstallation eines Programms wurde nicht abgeschlossen. Der Computer muss neu gestartet werden, um die Installation/Deinstallation zu beenden.%n%nStarten Sie das Setup nach dem Neustart Ihres Computers erneut, um das Update von [name] durchzuführen.
CannotContinue=Das Setup kann nicht fortfahren. Bitte klicken Sie auf "Abbrechen" zum Verlassen.

; *** "Installing" wizard page
WizardInstalling=Erneuere ...
InstallingLabel=Warten Sie bitte während [name] auf Ihren Computer erneuert wird.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Beenden des [name] Setup-Assistenten
FinishedLabelNoIcons=Setup hat das Update von [name] auf Ihren Computer abgeschlossen.
FinishedLabel=Setup hat das Update von [name] auf Ihren Computer abgeschlossen.
ClickFinish=Klicken Sie auf "Fertigstellen", um das Setup zu beenden.
FinishedRestartLabel=Damit das Update von [name] wirksam wird, muss Ihr Computer neugestartet werden. Möchten Sie jetzt neu starten?
FinishedRestartMessage=Damit das Update von [name] wirksam wird, muss Ihr Computer neugestartet werden.%n%nMöchten Sie jetzt neu starten?
...
EntryAbortRetryIgnore=Klicken Sie auf "Wiederholen" für einen weiteren Versuch, "Ignorieren", um trotzdem fortzufahren, oder "Abbrechen", um das Update abzubrechen.
...
StatusRunProgram=Update wird beendet ...
...
; *** File copying errors
FileAbortRetryIgnore=Klicken Sie auf "Wiederholen" für einen weiteren Versuch, "Ignorieren", um diese Datei zu überspringen (nicht empfohlen), oder "Abbrechen", um das Update abzubrechen.
FileAbortRetryIgnore2=Klicken Sie auf "Wiederholen" für einen weiteren Versuch, "Ignorieren", um trotzdem fortzufahren (nicht empfohlen), oder "Abbrechen", um das Update abzubrechen.
SourceIsCorrupted=Die Quelldatei ist beschädigt
SourceDoesntExist=Die Quelldatei "%1" existiert nicht
ExistingFileReadOnly=Die vorhandene Datei ist schreibgeschützt.%n%nKlicken Sie auf "Wiederholen", um den Schreibschutz zu entfernen, "Ignorieren", um die Datei zu überspringen, oder "Abbrechen", um das Update abzubrechen.
