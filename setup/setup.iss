...
#ifndef Update
Source: ..\..\portable\*; Excludes: python\Lib\distutils; DestDir: {app}; Flags: ignoreversion recursesubdirs
#endif
#ifdef Update
Source: ..\..\portable\python\Scripts\*; DestDir: {app}\python\Scripts; Flags: ignoreversion recursesubdirs
Source: ..\..\portable\python\Lib\site-packages\zeroinstall\*; DestDir: {app}\python\Lib\site-packages\zeroinstall; Flags: ignoreversion recursesubdirs
#endif
